...
<section class="unpad">
                <article>
                    ...
                    <div class="imagebg text-center height-40" data-overlay="5">
                        <div class="background-image-holder"> <b-img :src="document.main_image.url"  :alt="document.title[0].text"></b-img> </div>
                        <div class="container pos-vertical-center">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="article__title">
                                        <h1>{{document.title[0].text}}</h1> <span>{{ document.date | moment('LL') }} </span> </div>
                                </div>
                            </div>
                        </div>
 ...
 components: {
  ...
  async asyncData({ context, error, req }) {
    try {
      ...
      let document = {};
      const result = await api.getByUID('blog', '13-bbq-and-grilling-tips-and-tricks-you-need-to-know')
